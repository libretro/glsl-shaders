...
void main()
{
    ...
    vec4 _shadows;
    vec4 _out_color;
    _TMP0 = COMPAT_TEXTURE(Pass2Texture, TEX0.xy - vec2(screen_offset_x * TEX1.x, screen_offset_y * TEX1.y));
    ...
    _TMP2 = COMPAT_TEXTURE(Texture, _c0022 - (vec2(shadow_offset_x * TEX1.x, shadow_offset_y * TEX1.y) + vec2(screen_offset_x * TEX1.x, screen_offset_y * TEX1.y)));
    ...
    _TMP12 = max(vec3( bg_smoothing, bg_smoothing, bg_smoothing), vec3(float(_TMP10.x), float(_TMP10.y), float(_TMP10.z)));
    _TMP39 = vec3(float(_TMP12.x), float(_TMP12.y), float(_TMP12.z));
    _background.xyz = _TMP39;
    _out_color = _shadows*_shadows.w*shadow_opacity + _background*(1.00000000E+00 - _shadows.w*shadow_opacity);
    _out_color = _foreground*_foreground.w*(1.00000000E+00 - _foreground.w*_foreground.w*contrast) + _out_color*(screen_light - _foreground.w*contrast*pixel_opacity);
