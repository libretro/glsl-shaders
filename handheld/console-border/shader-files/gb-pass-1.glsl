...
#pragma parameter adjacent_texel_alpha_blending "Texel Alpha Blending" 0.38 0.01 1.0 0.01
...
void main()
{
    ...
    _TMP52 = float(_TMP11);
    _COLOR0017.w = _out_color.w - ((_out_color.w - _adjacent_texel_10017.w) + (_out_color.w - _adjacent_texel_20017.w) + (_out_color.w - _adjacent_texel_30017.w) + (_out_color.w - _adjacent_texel_40017.w))*adjacent_texel_alpha_blending*blending_mode;
