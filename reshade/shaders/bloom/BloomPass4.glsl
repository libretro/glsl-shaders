...
void main()
{
   ...
   bloom.w = GaussBlur22(vTexCoord, SamplerBloom4, 32. * fAnamFlareWideness, 0., false).w * 2.5; // to have anamflare texture (bloom.w) avoid vertical blur
   FragColor = bloom;
} 
#endif
