...
#pragma parameter info "To be used at 5x integer scale" 0.0 0.0 0.0 0.0
...
void main()
{
  vec4 res =COMPAT_TEXTURE(Source, vTexCoord);
   ...
   lum = mix(1.0,0.3,lum);
   vec4 mask = COMPAT_TEXTURE(MASK, fract(gl_FragCoord.xy / maskSize));
