...
void main()
{
    ...
    vec3 gtmp = vec3(gamma_out*COMPAT_TEXTURE(Texture, pC4      ).a);
    vec3 scolor1 = (sl2*twl2 + sl1*twl1 + sct*twct + sr1*twr1 + sr2*twr2)*wtt;
    ...
    vec3 scolor2 = (sl2*bwl2 + sl1*bwl1 + sct*bwct + sr1*bwr1 + sr2*bwr2)*wtb;
