...
#pragma parameter posx "TV Angle X" -0.25 -1.0 1.0 0.05
#pragma parameter posy "TV Angle Y" 0.2 -1.0 1.0 0.05
#pragma parameter targetx "Cam Pos X" 0.0 -1.0 1.0 0.05
#pragma parameter targety "Cam Pos Y" 0.10 -1.0 1.0 0.05
#pragma parameter zoom "Cam Zoom" -0.6 -10.0 10.0 0.1
#pragma parameter showSphere "Show Sphere" 0.0 0.0 1.0 1.0
#pragma parameter sphereX "Sphere X Pos" 0.2 -10.0 10.0 0.05
...
SurfaceInfo Scene_GetSurfaceInfo( const in vec3 vRayOrigin,  const in vec3 vRayDir, SceneResult traceResult )
{
    ...
    {
    	surfaceInfo.vR0 = vec3( 0.02 );
	    surfaceInfo.vAlbedo = textureLod( table, traceResult.vUVW.xz * vec2(-0.00, -0.0), 0.0 ).rgb;
