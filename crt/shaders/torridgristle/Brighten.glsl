...
uniform COMPAT_PRECISION float BrightenLevel, BrightenAmount;
#else
#define BrightenLevel 2.0
#define BrightenAmount 0.1
#endif
...
void main()
{
    ...
    FragColor = vec4(mix(Picture,1.0-pow(1.0-Picture,vec3(BrightenLevel)),BrightenAmount),1.0);
} 
#endif
